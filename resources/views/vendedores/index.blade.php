  ...
  <div class="max-w-7xl mx-auto space-y-6">
    ...
    <form method="GET" action="{{ route('vendedores.index') }}"
      ...
      <div class="flex items-end justify-end gap-2">
        ...
        <a href="{{ route('vendedores.index') }}" class="h-10 px-4 rounded-lg border text-sm text-gray-700">Limpiar</a>
      </div>
    </form>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                  <div class="flex justify-end gap-1">
                    <a href="{{ route('vendedores.show', $u) }}"
                    ...
                    <a href="{{ route('vendedores.edit', $u) }}"
                    ...
                    <form method="POST" action="{{ route('vendedores.destroy', $u) }}"
            ...
            @empty
              <tr>
                <td colspan="6" class="px-4 py-8 text-center text-gray-500">No hay vendedores registrados.</td>
              </tr>
            @endforelse
          </tbody>
        </table>
